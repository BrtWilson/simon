const btnDescriptions = [
    {file: 'sounds1.mp3', hue: 120},
    {file: 'sounds2.mp3', hue: 0},
    {file: 'sounds3.mp3', hue: 60},
    {file: 'sounds4.mp3', hue: 240},
];
    ...
    constructor() {
        ...
        document.querySelectorAll('.game-button').forEach((el, i) => {
            if (i < btnDescriptions.length) { 
                // creating the map of buttons: [ element id, sound ]
                this.buttons.set(el.id, new Button(btnDescriptions));
            }
        });
